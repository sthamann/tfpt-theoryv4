...
\begin{theorem}[\textnormal{[M]} Determinant-line axion interface and scalaron reheating data]
...
\begin{theorem}[\textnormal{[M]} Boundary winding controls family, transport, and determinant closure]
...
\begin{theorem}[\textnormal{[M]} Canonical leptogenesis interface on the closed branch]
...
\begin{theorem}[\textnormal{[M]} FRW reduction and cosmology interface data on the closed branch]
