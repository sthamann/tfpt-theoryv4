...
**Scorecard (auto-generated from `evidence_scorecard.json`): 114 Zeilen — 47 consistent, 9 tension, 24 null, 33 data_limited, 1 parked.**

- nach `evidence_class`: 20 downstream_bridge, 28 external_data, 11 internal_consistency, 1 parked, 54 search_target
- nach `leakage_class`: 3 architecture_core, 2 core_operator, 1 detector_control, 20 downstream_bridge, 25 external_data, 10 internal_kernel, 1 parked, 13 search_target, 39 surface_leakage
...
- nach `independence_group`: 4 N_star_reheating, 4 alpha_em, 1 c3_topform_horizon, 2 carrier_ps_so10_uv_branch, 2 cp_mu6_phase, 83 independent, 2 koide_q_pole, 2 nu_mass_floor, 14 phi0_seed
