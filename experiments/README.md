...
**Scorecard (auto-generated from `evidence_scorecard.json`): 72 Zeilen — 34 consistent, 4 tension, 13 null, 20 data_limited, 1 parked.**

- nach `evidence_class`: 15 downstream_bridge, 24 external_data, 9 internal_consistency, 1 parked, 23 search_target
- nach `independence_group`: 4 N_star_reheating, 3 alpha_em, 1 c3_topform_horizon, 2 cp_mu6_phase, 54 independent, 8 phi0_seed
