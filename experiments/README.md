...
**Scorecard (auto-generated from `evidence_scorecard.json`): 115 Zeilen — 47 consistent, 9 tension, 25 null, 33 data_limited, 1 parked.**

- nach `evidence_class`: 20 downstream_bridge, 28 external_data, 11 internal_consistency, 1 parked, 55 search_target
- nach `leakage_class`: 3 architecture_core, 2 core_operator, 1 detector_control, 20 downstream_bridge, 25 external_data, 10 internal_kernel, 1 parked, 13 search_target, 40 surface_leakage
- nach `signature_code`: 3 S1, 1 S1/S10, 2 S1/S2b/S3, 1 S1/S7, 2 S10, 1 S10e, 1 S12, 1 S12/S5, 2 S13, 1 S1e, 1 S2a, 1 S2a/S4/S5/S6/S7/S8-proxy, 1 S2a/S5, 9 S2b, 1 S2b/S11, 2 S2b/S14, 1 S2b/S3, 2 S3, 1 S3/S2b, 2 S4, 1 S4/S5, 2 S5, 2 S7, 1 S8, 1 S8-data/S15, 1 S9, 1 detector-control
- nach `independence_group`: 4 N_star_reheating, 4 alpha_em, 1 c3_topform_horizon, 2 carrier_ps_so10_uv_branch, 2 cp_mu6_phase, 84 independent, 2 koide_q_pole, 2 nu_mass_floor, 14 phi0_seed
- `alternative_group` (eine Frage, mehrere Lesarten — *nicht* doppelt zählen): 2 HVP_baseline, 2 Nstar_branch, 5 axion_branch, 3 w_de_eos
...
| **Sauberer Nullbefund** | FRB.02, FRB.02b, FRB.04, FRB.06, FRB.07, FRB.08, FRB.09; **Pulsar PG.01/02/03** (Kernel-Comb null; `Δν/ν`-Struktur = bekannte 2-Populations-Bimodalität) **+ PG.04** (Recovery `Q` nicht an φ₀-Vielfachen, `τ_d`-Multikomponenten-Leiter null; echte Yu+2013-Daten); **NEU: QPE.01** (Rekurrenz-Ratio-Leiter null in eRO-QPE2 + GSN 069; der 2/3-Zahn liegt >17× die beobachtete Streuung entfernt — ausgeschlossen, nicht bloß unbeobachtet) | Muster nachweislich **nicht** da, über mehrere Quellen / der eingefrorene Kernel maskiert sich **nicht** in einem dritten, physikalisch unverwandten Datensatz |
