"""seam_alignment_bit_twist_state_probe.py -- EXPLORATION ONLY (experiments/, no verification claim).
...
Run:  . experiments/tfpt-discovery/.venv/bin/activate
      python experiments/tfpt-discovery/seam_alignment_bit_twist_state_probe.py
"""
import time
...
# ---------------------------------------------------------------------------
def run():
    print("seam_alignment_bit_twist_state_probe: do mark-decorated STATES "
