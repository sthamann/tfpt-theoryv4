...
(\veri{v512\_seam\_tau\_flag.py}, \texttt{SEAM.TAU.FLAG.01}); plus the \mC\ identifications R1/R2
of \vref{v499}. In one sentence: \textbf{the compiler's dimensionless inputs reduce to four marks
(derived from P1-side topology), one discrete symmetry-lift bit (flag transitivity $\iff\tau=i$),
and $\pi$.} This is a reduction \emph{state}, not an abolition of
