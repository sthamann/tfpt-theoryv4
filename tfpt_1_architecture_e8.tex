...
\input{tfpt_docset}
\noindent\textbf{You are reading document \#2.}
...
(the source-layer transport theorem; document~3). \emph{Consequence \tP:} the seam's single scalar two-point kernel is necessarily a
...
(\veri{v137\_qplus\_cohomology.py}). What remains of the old residual is the much smaller selector
establishment R4$'$ (research contracts): derive the three atom pairings of the torsion normal. \tI\,$+$\,\tP
\end{auditbox}
...
Strong CP & $\theta_{\rm eff}=0$ (determinant erasure; document~3, Part~III) & --- & \tI \\
...
\emph{Stage 2 ($A_3$, \tI):} the carrier geometry fixes $X_f^\circ=\mathbb P^1\setminus\mu_4$ with
...
$\mu_4$ glue ($240$ roots, $\det1$). The only residual \tP\ is the analytic identification of the carrier geometry's
