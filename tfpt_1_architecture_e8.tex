...
establishment R4$'$ (research contracts): derive the three atom pairings of the torsion normal. \mE/\mC
\par\smallskip
...
Strong CP & $\theta_{\rm eff}=0$ (determinant erasure; document~3, Part~III) & --- & \mE \\
...
\item \textbf{SM completeness.} The discrete structure and dimensionless core are closed; the
  ...
  genuinely open SM point is the \emph{exact} solar angle $\theta_{12}$ (leading $1/\Nfam=\tfrac13$). \mC
\end{enumerate}
...
sets $=D_6$ orbit of $\{0,1,3\}$, minus anchor, monotone) \mE. The single remaining geometric input is
...
cusp-position shortcut explicitly ruled out \mC. The explicit Riemann--Hilbert construction confirms
