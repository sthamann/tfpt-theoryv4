...
\par\smallskip\noindent\textbf{The Pascal grammar: one $\Lambda^\bullet$ mechanism in four places (anti-numerology) \tI.}
...
\par\smallskip\noindent\textbf{The metric, settled (former \tP).}
...
\par\smallskip\noindent\textbf{Two carrier roots generate the family and the transport cusps \tI.}
...
\par\smallskip\noindent\textbf{One seed, four readouts (and their inverses) \tI.}
\[
...
\par\smallskip\noindent\textbf{Why \emph{this} function: the boundary $U(1)$ Ward reading (Theorem C) \tI/\tP.}
...
\par\smallskip\noindent\textbf{Non-circularity (\tA, essential).}
...
\par\smallskip\noindent\textbf{Prefactor branch (\tA).}
...
\par\smallskip\noindent\textbf{Mandatory $\Lambda$-layer typing (\tA).}
...
\par\smallskip\noindent\textbf{Honest obstruction (\tA).}
...
\par\smallskip\noindent\textbf{Audit only --- \emph{non-load-bearing} speculation: the $\dim 496$ heterotic count \tA.}
