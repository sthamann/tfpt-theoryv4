...
\textbf{Kernel choice:} we identify the kernel coupling with hypercharge, $\alpha_{\mathrm{kernel}}=\alpha_Y$.
...
\textbf{Status:} these identities are enforced by the EW-mixing and Thomson-limit audits.
\end{tcolorbox}
...
\text{checks}=\TFPTTheoryVThreeChecksTotal\ (\mathrm{PASS/FLAGGED/OPEN}=\TFPTTheoryVThreeChecksPassTotal/\TFPTTheoryVThreeChecksWarnTotal/\TFPTTheoryVThreeChecksFailTotal),\qquad
...
\texttt{baryon\_consistency\_audit} & Baryon consistency / H0 audit & FLAGGED & 3/4 & yes\\
...
\texttt{yukawa\_exponent\_index\_audit} & Yukawa exponent-index mapping & FLAGGED & 3/7 & yes\\
\texttt{yukawa\_index\_mapping\_audit} & Yukawa index mapping & FLAGGED & 3/7 & yes\\
\bottomrule
\end{tabularx}
...
\begin{itemize}[leftmargin=1.5em, topsep=2pt, itemsep=1pt]
    ...
    \item Verification suite modules include: \texttt{effective\_action\_r2}, \texttt{bounce\_perturbations} (see the replication bundle and the generated report \texttt{tfpt-test-results-v27.pdf})
\end{itemize}
