...
Bittleston--Homans--Sharma on ALE spaces; Costello's twistorial SDYM) produces a coherent eleven-step
story --- executed as work packages WP1--WP5d (both WP5d stages) plus the WP5e $\alpha$ and $\beta$
stages of the research contract
...
verified --- with the rigid $32\,T_3$ twisted residual and the sphere-axion pairing as the named
remaining targets, and preregistered success/kill criteria in the contract --- together with the
