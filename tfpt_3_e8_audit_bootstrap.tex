...
\end{enumerate}
\textbf{You are reading document \#4.}
\end{keybox}
...
\noindent The single remaining flavor-geometry step (H2) is sharpened in the parabolic note to:
...
matrix'', but ``prove this one geometric realisation''.
