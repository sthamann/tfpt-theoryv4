...
(\veri{v507\_seam\_bit\_origin.py}, \texttt{SEAM.BIT.ORIGIN.01}, markers unchanged).
...
postulate itself, is the \mO\ input layer (\texttt{AX.P2.01} stays a declared axiom).
\par\smallskip
