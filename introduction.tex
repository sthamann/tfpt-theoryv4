...
tier B, v76). So the only genuine residuals are \emph{one} dimensionful scale $v_{\mathrm{geo}}$ (shared by
flavor and gravity), the open ambient \emph{boundary} projective limit ($G_{\mathrm{metric}}$, constructive
grade), and the named QFT/cosmology transfer interfaces ($F_{\mathrm{frontier}}$).
\smallskip\\
