...
\texttt{v124\_\allowbreak resummed\_\allowbreak clock.py} & Resummed clock (R1-Bend in geschlossener Form): Transfer-Eigenwerte $=$ exakt $(1{-}n/\Nfam)^{2p_2}$ $\Rightarrow$ $\mathrm{rate}(n){=}{-}2p_2\ln(1{-}n/\Nfam)$ reproduziert $\{0,\Delta,6\ln3\}$, Bend $\log_{3/2}3$ einzeilig; Linearisierung tr\"agt Steigung $|\Z_2|{=}2$ relativ zur klassischen GP-Uhr $\{0,-1,-2\}$; Pol bei $n{=}\Nfam$ erzwingt das Drei-Niveau-Spektrum; R1-Ziel jetzt geschlossen-formig \tI\,$+$\,\tP \\
