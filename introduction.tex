...
full PMNS dynamics (mass scale, CP) & \mC/\mO & angles typed; CP strength $J_{\mathrm{PMNS}}{=}{-}0.0297$ derived (\vref{v270}); absolute $\nu$-scale $=$ one seesaw ratio (\vref{v272}); two named post-hoc \mO\ candidates: third-gen ladder-base pattern (\vref{v467}) and $\Delta m^2$ ratio $=|J|$ (\vref{v468}) --- record unchanged \\
