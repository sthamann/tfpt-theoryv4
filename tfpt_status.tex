...
% ---------------------------------------------------------------------
\begin{keybox}[TFPT status at a glance --- read this card the same way in every document]
...
(\tI/\tL/\tF); the everything-open residual reduces to \emph{three named interface problems}:
\begin{center}\small
...
\midrule
$v_{\mathrm{geo}}$ & the one dimensionful scale anchor (same nature as $1/G$) & reduced \tA \\
$G_{\mathrm{net}}$ & the index-4 seam-net inclusion certifying the metric sector & open \tB/\tA \\
$F_{\mathrm{transfer}}$ & source$\to$pole / relic / cosmology transport (Koide, $\eta_B$, axion, $m_p/m_e$) & open \tB/\tP \\
\bottomrule
\end{tabular}
\end{center}
