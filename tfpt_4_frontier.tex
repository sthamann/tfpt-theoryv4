...
WP5e $\alpha$ and $\beta$ stages executed:
...
side, and the equivariant anomaly ledger exact on the twistor side (index bridge, $-78$ defect,
rigid $32\,T_3$ residual, the honest $a_0$ refutation); WP5e proper \mO, the global BCOV
