...
and the $q^{-1/3}$ prefactor $+$ level $k{=}1$ pinned on the CFT
side; WP5e proper \mO, the BCOV/Costello--Li twistor inflow, the single remaining milestone) --- is
synthesised as a
