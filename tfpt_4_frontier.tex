...
approach to the keystone --- the celestial route (contract \texttt{CELEST.SEAM.01}, WP1--WP5d, both
WP5d stages, plus the
WP5e $\alpha$, $\beta$, $\gamma$, $\delta_2$ and $\varepsilon_2$ stages executed:
...
open, and ``one level'' lifted to a theorem of clock invariance with the sector
counter pinning $k=1$ (\vref{v508}/\vref{v509}/\vref{v511}); WP5e proper \mO, the global BCOV
