...
WP5e $\alpha$, $\beta$, $\gamma$, $\delta_2$, $\varepsilon_2$ and $\varepsilon_1$ stages and the
M1 back-reaction milestone executed:
...
slot built with $\tilde\lambda=6$ triply pinned (\vref{v514}), and the back-reacted $\Omega_N$
closed-form with $(2\pi i)^2$-integral lockstep periods and the lens-forced source charge
$4=|\mu_4|$ (\vref{v515}; M2--M3 stay \mO); WP5e proper \mO, the global BCOV
quantisation, the single remaining milestone) --- is
synthesised as a
