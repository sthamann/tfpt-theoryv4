...
(M1--M3 and the $\delta$-chains executed and decided; $\alpha/\beta_1/\beta_2$ executed, $\beta_3$ next)}
...
$\beta_3$ is next, now under the \emph{straddle-law} constraint: the first interacting seam toy
...
$\mathcal A_{\mathrm{hol}}$. Both contracts stay \mO; no marker moves.
\end{keybox}
...
$13\to15$; \mC\ interferometric measurement sketch; the bit remains formal input).
...
twist-class choice, in principle interferometrically readable).
...
quartet-avoiding ones; $24/24$) as a concrete hurdle for $\beta_3/\gamma$. Fence: one toy / one
