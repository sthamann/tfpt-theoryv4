...
\item \textbf{Citation gaps closed.} The audit immediately found three scripts cited
  ...
  \vref{v91} (spine tetrahedron) is recorded in \texttt{audit\_baseline.json} as a known
...
\item \textbf{Rules.} \texttt{.cursor/rules} updated (\texttt{tfpt-workflow},
  ...
  procedure: enumerate affected surfaces from the maps first, audit as the exit gate.
\end{itemize}
