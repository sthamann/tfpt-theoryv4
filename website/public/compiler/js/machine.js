  ...
  function deepGravity() {
    return `
      ...
      <div class="deep-sec"><h4>Quantum field theory \u2014 the scaling limit is (E\u2088)\u2081</h4>
        <p class="deep-p">The boundary is an <b>emergent chiral QFT</b>: one anomaly-free generation, a spectral-triple / boundary-net description, with modular (KMS) flow in the role of time. The SM fields are projections of this boundary data \u2014 not added by hand. As of the 2026-06 work its <b>scaling limit is pinned to the affine (E\u2088)\u2081</b> at every computable level \u2014 central charge c = 8, the E\u2084/\u03b7\u2078 character (248 currents, one primary), the genus-1 torus count = 1, and reflection positivity (v376\u2013v379, mirrored in Lean) \u2014 <b>closed modulo the cited MMST continuum theorem</b>.</p></div>
