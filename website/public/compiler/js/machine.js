...
(function () {
  ...
  function deepGravity() {
    return `
      ...
      <div class="deep-sec"><h4>Quantum field theory \u2014 the scaling limit is (E\u2088)\u2081</h4>
        <p class="deep-p">The boundary is an <b>emergent chiral QFT</b>: one anomaly-free generation, a spectral-triple / boundary-net description, with modular (KMS) flow in the role of time. The SM fields are projections of this boundary data \u2014 not added by hand. As of the 2026-06 work its <b>scaling limit is pinned to the affine (E\u2088)\u2081</b> at every computable level \u2014 central charge c = 8, the E\u2084/\u03b7\u2078 character (248 currents, one primary), the genus-1 torus count = 1, and reflection positivity (v376\u2013v379), the closure Lean-pinned (FORM.SEAM.MMST.01) \u2014 <b>closed modulo the cited MMST continuum theorem</b>.</p></div>
      ...
      <div class="deep-sec"><h4>Quantum gravity \u2014 the measure is no longer a swamp</h4>
        <p class="deep-p">With a parameter-free saddle the path integral becomes a <b>one-loop Gaussian fluctuation</b> around it: the stiffness is fixed (1/c\u2083 = 8\u03c0), the fluctuation operator is <b>gapped</b> (\u0394_eff \u2248 1.648 &gt; 0) so it converges mode-by-mode, with <b>zero</b> new dials (v365). The would-be <b>Stelle ghost</b> turns out to be exactly a Seeley\u2013DeWitt <b>truncation artefact</b> \u2014 each finite truncation carries a ghost zero, the resummed (entire) KMS form factor has none \u21d2 perturbative graviton unitarity (v370/v380). And the <b>ambient bulk sector is physically redundant</b> relative to the (E\u2088)\u2081 boundary (DHR = Vec, |det K| = 1, finite Petz recovery (2/3)\u2076), so the QG measure is a <b>certification</b> object, not missing dynamics (v369): <i>Gravity-complete = boundary-complete + ambient-redundant.</i></p></div>
      <div class="deep-frontier"><b>Honest frontier:</b> this is still the Jacobson <b>equation-of-state</b> derivation (a conditional framework), not a from-action quantisation (an external candidate action \u2014 Bianconi's entropic action, PRD 111, 066001 (2025) \u2014 is quantified in v473 with \u03b2\u2032_B = c\u2083/6 pinned, typing unchanged). Two genuinely hard, <b>external</b> residuals remain \u2014 the non-perturbative ambient measure (constructive QFT; gap-decoupled, blocks no test) and the lattice\u2192continuum existence of the seam scaling limit (the cited MMST theorem). Both are now single, <b>theorem-bounded</b> reductions, not diffuse \u201cfull QG\u201d gaps. The only thing still dimensionful is the unit v_geo (open the readout box \u2192).</div>`;
  }
  function deepTally() {
    return `
