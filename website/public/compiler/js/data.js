...
(function () {
  ...
  const stations = [
    ...
    { id: "cosmo", kind: "stage", x: 0.84, y: 0.63, accent: "#a78bfa", icon: "\u272a", belt: "physics",
      ...
      atoms: ["G_ab = c\u2083\u207b\u00b9 T_ab DERIVED from \u03b4S = \u03b4\u27e8K\u27e9 (parameter-free)", "c\u2083 triply over-determined: anchor \u00b7 geometry \u00b7 thermodynamics", "Stelle ghost cured (v370/v380); QG measure reduced \u2014 ambient sector redundant (v365/v369)"],
      detail: "The SAME edge, read as a horizon, gives gravity, an emergent quantum field theory and cosmology. As of the 2026-06 work, Einstein's equation is DERIVED parameter-free from entanglement equilibrium (\u03b4S = \u03b4\u27e8K\u27e9): G_ab + \u039b g_ab = c\u2083\u207b\u00b9 T_ab with 8\u03c0 = 1/c\u2083 (v358/v359) and \u039b from \u03b1 (v60). The R+R\u00b2 scalaron is the calculable correction; the Stelle ghost is a truncation artefact, cured by the resummed KMS form factor (v370/v380); and the QG measure reduces to one-loop fluctuations around the parameter-free saddle with a physically redundant ambient sector (v365/v369). The scaling limit of the boundary QFT is pinned to (E8)\u2081 (v376\u2013v379). What remains are two external, theorem-bounded residuals (the non-perturbative measure + the (E8)\u2081 continuum existence) and the one unit v_geo." },
