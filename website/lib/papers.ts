...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    contribution: [
      ...
      "Two independent paths + red team: an independent Wolfram engine (116/116 + 450/450) and a Lean 4 kernel proof (hypercharge, anomaly, Pascal ladder, seam chain) re-derive the exact core, and the red-team companion attacks the theory and publishes what survives each attack.",
    ],
    notClaimed: [
    ...
    highlights: [
      ...
      { label: "Independent paths", value: "2", description: "Wolfram (116+450) + Lean 4 kernel proof re-derive the exact core" },
