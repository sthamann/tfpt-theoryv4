...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        value: "11 steps, WP5d complete + WP5e-α/β",
        description: "Dedicated section: μ₄ glue = flat ℤ₄ monodromy on the A₃ ALE, clock² = deck, null ideal 27000 = h∨³ derived, deleting operator explicit, GNS limit state constructed, two-interval index μ-chain 16→4→1 measured, split + strong additivity witnessed (all three KLM ingredients on the lattice, Xu's continuum theorem cited not claimed), the q^(−1/3) prefactor + level k = 1 pinned on the CFT side, and the equivariant anomaly ledger exact on the twistor side (index bridge f(m) = ch₂, glue defect −78, rigid 32·T₃ residual, a₀ refuted as GS axion) (v492–v505); WP5e proper (the global BCOV quantisation) stays the single remaining milestone, SEAM.EQUIV.01 stays [O]",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    keyFormulas: [
      {
        ...
        description: "One statement; E₈ and the unique 2D bulk follow. (A) factors into the A2 net-existence + the keystone SEAM.EQUIV.01, now closed modulo cited theorems (lattice v367/v368 + S3 stack v376–v379, ground-state witnesses v489/v490; residual [O] = cited continuum existence (v336) + crossed-product certified extension leg (v469, LR/Böckenhauer/KLM; AGT/AMT second witness); stays [O]). [C]",
      },
      {
    ...
    highlights: [
      ...
      { label: "Target A", value: "closed mod cited", description: "Factors into the A2 net assembly + the keystone SEAM.EQUIV.01, now [C] closed modulo cited theorems (lattice v367/v368 + S3 stack v376–v379, ground-state witnesses v489/v490; residual [O] = cited continuum existence (v336) + crossed-product certified extension leg (v469, LR/Böckenhauer/KLM; AGT/AMT second witness); stays [O])" },
  ...
  },
  {
    ...
    highlights: [
      ...
      { label: "Seam Equivalence Theorem", value: "closed mod cited", description: "The core is the keystone SEAM.EQUIV.01 (the raw RP seam IS the holomorphic (E8)₁ net at τ=i), now [C] closed modulo cited theorems: pinned at every computable level by an explicit lattice model (v367/v368) and the S3 closure stack (v376–v379, ground-state witnesses v489/v490), Lean-pinned (FORM.SEAM.MMST.01) to the published MMST/Adamo theorems, residual [O] = cited continuum existence (v336) + crossed-product certified extension leg (v469, LR/Böckenhauer/KLM; AGT/AMT second witness); stays [O] — the theory's one irreducible structural postulate, the role the constancy of c plays in relativity" },
  ...
  },
  {
    ...
    contribution: [
      ...
      "Two independent paths + red team: an independent Wolfram engine (116/116 + 470/470) and a Lean 4 kernel proof (hypercharge, anomaly, Pascal ladder, seam chain) re-derive the exact core, and the red-team companion attacks the theory and publishes what survives each attack.",
    ],
    notClaimed: [
