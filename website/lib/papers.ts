...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    contribution: [
      ...
      "Two independent paths + red team: an independent Wolfram engine (116/116 + 429/429) and a Lean 4 kernel proof (hypercharge, anomaly, Pascal ladder, seam chain) re-derive the exact core, and the red-team companion attacks the theory and publishes what survives each attack.",
    ],
    notClaimed: [
