...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    subtitle: "The seven E₈ slices as an audit raster, the cascade spine, the Möbius loop — and the thirty-one-step celestial/twistor route with the measure chain derived",
    abstract:
    ...
    highlights: [
      ...
      },
      {
        ...
        value: "31 steps, WP5d complete + WP5e-α/β/γ/δ₁/δ₂/ε₂/ε₁ + M1–M3 + the measure decision + the w_m derivation + WOIT α/β₁/β₂ + thermal third leg of c3 + silver demystified + twist-class bit + FK-toy Kill-Test-2 shadow (scoreboard 10) + the straddle-cone selection law (RP selects the bit)",
  ...
  },
  {
    ...
    highlights: [
      ...
      { label: "Straddle law", value: "24/24 → selector", description: "Interacting RP fails exactly on quartet-straddled cuts (v529) — honest threat AND the first hard selection principle for A_hol; executed as a selector it keeps exactly one member alive: δ = π/2 with positive coupling, the first dynamical selection of the alignment bit (v534, toy-fenced); ten-test side-blind scoreboard on the bit (v521/v525/v529), twist-class definition (v528)" },
  ...
  },
  {
    ...
    contribution: [
      ...
      "Two independent paths + red team: an independent Wolfram engine (116/116 + 598/598) and a Lean 4 kernel proof (hypercharge, anomaly, Pascal ladder, seam chain) re-derive the exact core, and the red-team companion attacks the theory and publishes what survives each attack.",
    ],
    notClaimed: [
