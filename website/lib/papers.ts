...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      { label: "Seam Equivalence Theorem", value: "SEAM.EQUIV.01", description: "The one open core is now a single named theorem: the raw RP seam IS the holomorphic (E8)₁ net at τ=i. An import firewall keeps its two routes non-circular (v286); Route A reduces it to one standard import (v287); Route B proves the full-L² ℤ₄ lift, leaving 'why is the raw subprincipal mark-local?' (v288)" },
