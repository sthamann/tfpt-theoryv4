...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  },
  {
    ...
    short:
      "The named external reference frame for the celestial/twistor branch: Woit's Euclidean Twistor Unification (arXiv:2104.05099) — chiral Wick rotation is problematic for purely chiral theories; formulate Euclidean-holomorphically on twistor space PT and reconstruct the Lorentzian theory via a conjugation structure. TFPT has the ingredients (reflection positivity v379, OS reconstruction, ρ = clock v492, σ = deck/seam reflection v510) but NOT the bridge itself: the missing object is a global anti-linear map Θ: A(PT/Γ) → A(PT/Γ) with Θ² = 1 and ΘρΘ = ρ⁻¹ on the interacting algebra, plus reflection positivity of the interacting BCOV+SDYM functional — the content of the research contract WOIT.OS.TWISTOR.01 ([O], seven preregistered kill tests; 'this is the actual bridge from compiler to physics — everything in CELEST.SEAM.01 is preparation for it'). Until that exists, the Woit connection is a strong analogy, not a mathematical integration.",
  },
  {
    term: "Real structure Θ",
    alias: ["real structure", "Theta real structure", "anti-linear real structure"],
    short:
      "The anti-linear involution the OS twistor bridge needs: Θ² = 1, ΘρΘ = ρ⁻¹, induced by the seam reflection (the free covering deck, v510), acting on the interacting twistorial algebra A(PT/Γ). Its existence and compatibility with reflection positivity of the interacting functional is the open input of WOIT.OS.TWISTOR.01 — established today only at the free-collar level (RP v379, OS reconstruction via cited theorems).",
  },
  {
