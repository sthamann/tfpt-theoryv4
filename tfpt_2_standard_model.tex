...
\[
  M(s,t)=R+Q\,\operatorname{diag}(s,t,t):\qquad
  R=M(0,0),\quad K=M(1,-1),\quad L=M(2,0),\quad F:=R{+}Q=M(1,1),
\]
...
\[
  n\cdot\mathbf 1=2=|\Z_2|\ (\text{the per-winding determinant increment}),\qquad
  n^\top R=(8,0,0),\qquad n^\top L=(20,0,0):
\]
