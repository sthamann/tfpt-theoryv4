...
\midrule
\textcolor{tfgreen!60!black}{\textbf{Closed \tI}} & gauge group $3{+}2$, $\Nfam{=}3$, hypercharge; $\alpha^{-1}{=}137.0359992$; seed $\phiz$; CKM magnitudes $s_{12},s_{23},s_{13},\delta$; $\sin^2\theta_{13}$; \emph{all} charged-lepton masses (in $\phiz$); word-lengths $L$; \textbf{charged-lepton $\Lambda$ exact}; $v_{\mathrm{geo}}/\Mpl$; geometric quartic $\lambda_\Phi{=}\tfrac1{16\pi^2}$ \\
...
\textcolor{tfgold!75!black}{\textbf{Conditional \tN/\tP}} & the solar angle $\sin^2\theta_{12}=\tfrac13-\tfrac{\phiz}{2}$ (cond.\ derived, pending the seam-misalignment lemma); the quark $c$-\emph{ratios} are closed (v49/v71), only the absolute $c$-normalisation is the $U_f^\star$ anchor \\
\bottomrule
\end{tabularx}
\end{center}
\markerkey
