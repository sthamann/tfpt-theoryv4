...
$\|\operatorname{Pl}_R(K)\|_1=26=\operatorname{Pl}(L)_{13}$ (the $c_t/c_b$ denominator), and
$\sum\operatorname{Pl}_R(L)=20{+}30{+}10=60$ is the $E_8$ cascade start. So the three quark ratios are the
\emph{same} numbers read as anchor-plane Plücker invariants:
\[
  \frac{c_u}{c_d}=\frac{\gcar\,\|\operatorname{Pl}(K)\|_1}{\Nfam^2\,\Delta_Q},\qquad
  \frac{c_t}{c_b}=\frac{\Nfam}{\operatorname{Pl}(L)_{13}},\qquad
...
% =====================================================================
\section{The $Q,\Sigma$ projection algebra: masses and transport from one operator}
% =====================================================================
